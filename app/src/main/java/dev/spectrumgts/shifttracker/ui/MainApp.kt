...
import dev.spectrumgts.shifttracker.ui.screens.NotificationSettingsScreen
...
/**
 * Main UI Entry Point for the Shift Tracker application.
 * This composable manages the high-level scaffolding including drawers, top app bar, and screen transitions.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MainApp(
    viewModel: ShiftTrackerViewModel,
    ...
    // Determine if we should show the permanent navigation drawer based on screen size (Adaptive UI)
    ...
    BackHandler(enabled = (currentScreen != ScreenDestination.DASHBOARD) || (!showPermanentDrawer && drawerState.isOpen)) {
        if (!showPermanentDrawer && drawerState.isOpen) {
...
/**
 * Core layout scaffold containing the TopAppBar and the dynamic content area.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
    ...
    Scaffold(
                ...
                title = {
                    Text(
                        text = when (currentScreen) {
                            ...
                            ScreenDestination.NOTIFICATION_SETTINGS -> stringResource(R.string.menu_notification_settings)
        ...
        Box(
            ...
            AnimatedContent(
                ...
                transitionSpec = {
                    if (targetState == ScreenDestination.DASHBOARD) {
                        // Backward animation: slide in from left, slide out to right
                ...
                when (targetScreen) {
                        ...
                        DefaultScheduleScreen(
                            ...
                            onSaveFirstDayOfWeek = { firstDay ->
                                viewModel.saveAppSettings(
                                    ...
                                    notificationReminderEnabled = appSettings.notificationReminderEnabled
                                )
                            },
                    ...
                    ScreenDestination.NOTIFICATION_SETTINGS -> {
            ...
            // Global Overlay: Active Shift Input / Edit Dialog
